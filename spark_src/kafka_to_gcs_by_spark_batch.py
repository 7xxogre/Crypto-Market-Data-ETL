...
def get_kafka_offset(bootstrap_servers, topic_name, num_partition,
                     execution_date_str, interval_hours):
...
parser.add_argument('--interval-hours', required=True, type=int, help='execute frequency (hour)')
...
offsets = get_kafka_offset(kafka_bootstrap_servers, args.topic_name, 
                           args.num_partition, args.execution_date, 
                           args.interval_hours)
